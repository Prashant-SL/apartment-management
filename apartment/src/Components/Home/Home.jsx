...
export const Home = () => {
	...
	const getFlatsData = () => {
		setloading(true);
		fetch('https://apartmentassignment.herokuapp.com/flats')
			.then((res) => res.json())
			.then((data) => {
	...
	const getclassData = () => {
		fetch('https://apartmentassignment.herokuapp.com/residents')
			.then((res) => res.json())
	...
	const handleDelete = (id) => {
		fetch(`https://apartmentassignment.herokuapp.com/flats/${id}`, {
			method: 'DELETE',
		})
